...
!  Parameters:
!
!    Output, integer ( kind = 4 ) I4_UNIFORM, the random integer.
!
  implicit none
...
!@ SP  write ( *, '(a)' ) ' '
!@ SP  write ( *, '(a)' ) 'INITIALIZE - Note:'
!@ SP  write ( *, '(a)' ) '  The RNGLIB package has been initialized.'
...
!  Parameters:
!
!    Output, real ( kind = 4 ) R4_UNIFORM_01, a uniform random value in [0,1].
!
  implicit none
...
!
  r4_uniform_01 = real ( i, kind = 4 ) * 4.656613057E-10
...
!*****************************************************************************80
!
!! R8_UNIFORM_01 returns a uniform random double precision number in [0,1].
!
!  Discussion:
!
!    This procedure returns a random floating point number from a uniform 
...
!  Parameters:
!
!    Output, real ( kind = 8 ) R8_UNIFORM_01, a uniform random value in [0,1].
!
  implicit none
...
!  Scale it to a random real in [0,1].
!
  r8_uniform_01 = real ( i, kind = 8 ) * 4.656613057D-10
