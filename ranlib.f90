...
!
!    Output, real ( kind = 4 ) COVAR, the covariance of the two vectors.
!
  implicit none
  ...
  call stats ( y, n, avy, vary, ymin, ymax )
...
!
  if ( 1.0E+00 < aa .and. 1.0E+00 < bb ) then
    ...
    do
      ...
      z = u1 ** 2 * u2
      r = gamma * v - 1.3862944E+00
      s = a + r - w

      if ( 5.0E+00 * z <= s + 2.609438E+00 ) then
        exit
      end if
...
!
    ...
    beta = 1.0E+00 / b
    delta = 1.0E+00 + a - b
    k1 = delta * ( 0.0138889E+00 + 0.0416667E+00 * b ) &
      / ( a * beta - 0.777778E+00 )
    ...
    do
      ...
      if ( log ( z ) <= &
        alpha * ( log ( alpha / ( b + w ) ) + v ) - 1.3862944E+00 ) then
        exit
      end if
